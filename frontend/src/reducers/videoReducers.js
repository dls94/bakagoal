...
export const videoListReducers = (state = {videos: [] }, action) => {
    switch(action.type){
...
export const videoDetailsReducers = (state = {video: {}}, action) => {
    switch(action.type){
...
export const videoCreateReducers = (state = { }, action) => {
    switch(action.type){
...
export const videoUpdateReducers = (state = { video:{} }, action) => {
    switch(action.type){
