...
export const articleDetailsReducers = (state = {article: {}}, action) => {
    switch(action.type){
...
export const articleDeleteReducers = (state = { }, action) => {
    switch(action.type){
...
export const articleCreateReducers = (state = { }, action) => {
    switch(action.type){
...
export const articleUpdateReducers = (state = { article:{} }, action) => {
    switch(action.type){
