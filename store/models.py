...
class Product(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, default='Maillot_Third.jpeg')
    ...
    product_size = models.CharField(max_length=20, default=S, choices=PRODUCT_SIZES)
...
class Order(models.Model):
    ...
    deliveredAt = models.DateField(auto_now_add=True, null=True, blank=True)
